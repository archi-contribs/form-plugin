 ...
 */
public class FormTextFieldEditor extends FieldEditor {
	 ...
	 * @since 2.0
	 */
	public FormTextFieldEditor(String name, String labelText, int width, int strategy, Composite parent) {
		init(name, labelText);
	 ...
	 * @param parent the parent of the field editor's control
	 */
	public FormTextFieldEditor(String name, String labelText, int width, Composite parent) {
	 ...
	 * @param parent the parent of the field editor's control
	 */
	public FormTextFieldEditor(String name, String labelText, Composite parent) {
	...
	protected void doLoad() {
		if (this.textField != null) {
			String value = FormPlugin.INSTANCE.getPreferenceStore().getString(getPreferenceName());
	...
	protected void doLoadDefault() {
		if (this.textField != null) {
			String value =
					FormPlugin.INSTANCE.getPreferenceStore().getDefaultString(getPreferenceName());
			this.textField.setText(value);
		}
		valueChanged();
	}
	...
	protected void doStore() {
		FormPlugin.INSTANCE.getPreferenceStore().setValue(getPreferenceName(), this.textField.getText());
	}
	...
	public String getStringValue() {
		...
		return FormPlugin.INSTANCE.getPreferenceStore().getString(getPreferenceName());
	}
		...
		if (this.textField == null) {
			...
			this.textField.addDisposeListener(new DisposeListener() {
				...
				public void widgetDisposed(DisposeEvent event) {
					FormTextFieldEditor.this.textField = null;
				}
			});
