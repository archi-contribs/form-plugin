...
public class ComboComposite extends Composite implements CompositeInterface {
	...
	private void createContent() {
        ...
        this.editableEditor.setTooltipText("Specifies if the variable value can be updated by the user.\n\nDefault: true.");
        ...
        this.excelSheetEditor.setPosition(this.whenEmptyEditor.getControl());
