...
public class ImageColumnComposite extends Composite implements CompositeInterface {
	...
	public ImageColumnComposite(Composite parent, int style) {
		super(parent, style);
	...
	private void createContent() {
		...
		this.colorEditor.setPosition(this.imageEditor.getControl());
