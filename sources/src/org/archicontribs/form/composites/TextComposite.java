...
public class TextComposite extends Composite {
	...
	private void createContent() {
        ...
        // excelSheet
        excelSheetEditor = new StringEditor(this);
        excelSheetEditor.setPosition(alignmentEditor.getControl());
        excelSheetEditor.setLabel("Excel sheet:");
        ...
        // excelCell
        excelCellEditor = new StringEditor(this);
        excelCellEditor.setPosition(excelSheetEditor.getControl());
        excelCellEditor.setLabel("Excel cell:");
        ...
        // excelCellType
        excelCellTypeEditor = new ComboEditor(this);
        excelCellTypeEditor.setPosition(excelCellEditor.getControl());
        excelCellTypeEditor.setLabel("Excel type:");
        ...
        // excelDefault
        excelDefaultEditor = new ComboEditor(this);
        excelDefaultEditor.setPosition(excelCellTypeEditor.getControl());
        excelDefaultEditor.setLabel("Excel default:");
